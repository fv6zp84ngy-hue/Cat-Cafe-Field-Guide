...
A personal, editorial map of cozy cat cafes and their resident cats — styled as a vintage paper field guide with a focused product scope:
...
This project uses a deliberately small static architecture:

- Vite + React + TypeScript + Tailwind
- Static publishing workflow
- Dev-only admin mode
- JSON-file content model
- `public/photos/` image storage
- Paper guide visual language
...
Map images stay in `public/map_north.png` and `public/map_south.png`.
